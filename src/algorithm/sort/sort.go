...
例子:
	...
	fmt.Println(list) // [1 2 3 4 5]
*/
func HeapSort[T cmp.Ordered](array []T) []T {
	panic("Pending implementation")
}
...
例子:
	...
	fmt.Println(list) // [1 2 3 4 5]
*/
func BucketSort[T cmp.Ordered](array []T) []T {
	panic("Pending implementation")
}
...
例子:
	...
	fmt.Println(list) // [1 2 3 4 5]
*/
func ShellSort[T cmp.Ordered](array []T) []T {
	panic("Pending implementation")
}
...
例子:
	...
	fmt.Println(list) // [1 2 3 4 5]
*/
func TournamentSort[T cmp.Ordered](array []T) []T {
	panic("Pending implementation")
}
...
例子:
	...
	fmt.Println(list) // [1 2 3 4 5]
*/
func TimSort[T cmp.Ordered](array []T) []T {
	panic("Pending implementation")
}
